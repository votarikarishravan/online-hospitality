						...
						<div class="card-body">
							<div class="table-responsive">
								...
								<table class="datatable table table-hover table-center mb-0">
									...
									<tbody>
										<%
											int id = ((Integer) session.getAttribute("doctorId")).intValue();

											DoctorDao dao = new DoctorDao();
											PatientDao pDao = new PatientDao();
											List<Appointment> list = new AppointmentDao().getAllAppointmentByDoctorId(id);
										...
										<tr>
											...
											<td>
												<h2 class="table-avatar">
													<a href="profile.html"><%=pDao.getPatientById(a.getPatientId()).getName()%></a>
												</h2>
											</td>
											<td><%=a.getBookingDate()%> <span
												class="text-primary d-block">Time slot: <%=a.getTimeSlot()%></span>
											</td>
											<%
												int appoId = a.getId();
