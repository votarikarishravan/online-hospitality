				 ...
				 <div class="card-body px-5">
                            ...
                            <form action="ChangePassword" method="post" onsubmit="return changePasswordValidate()">
                                <div class="form-group form-focus">
                                    ...
                                    <input type="number" class="form-control floating" id="mobnum" name="mobile" required>
                                   
                                </div>
                                <div class="form-group form-focus">
                                    <label class="focus-label">New Password</label>
                                    <input type="password" class="form-control floating" name="npassword" id="password" required>
                                    
                                </div>
                                <div class="my-2"><span class="text-danger" id="etag"></span></div>
                                <div class="form-group form-focus">
                                    <label class="focus-label">Confirm Password</label>
                                    <input type="password" class="form-control floating" name="cpassword" id="confirmPassword" required>
